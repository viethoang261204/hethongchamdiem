  ...
  return (
    <div className="admin-login-page">
      <div className="login-stars" aria-hidden="true">
        {stars.map(s => (
          <span key={s.id} className="login-star" style={{
            '--x': `${s.x}%`, '--y': `${s.y}%`,
      ...
      <div className="admin-login-led-wrap">
        <div className="admin-login-card">
          ...
          <div className="admin-login-right">
            ...
            {error && <div className="admin-login-error-box">{error}</div>}
            <form onSubmit={handleSubmit} className="admin-login-form">
              <div className="form-group">
                <label>Email</label>
                <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="referee@example.com" required autoComplete="email" />
              </div>
              <div className="form-group">
                ...
                <div className="admin-login-password-wrap">
                  ...
                  <button type="button" className="admin-login-password-toggle" onClick={() => setShowPassword(!showPassword)}>
                    {showPassword ? (
